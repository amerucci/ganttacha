...
class Gantti {
  ...
  function render() {
    ...
    foreach($this->blocks as $i => $block) {
      ...
      $html[] = '<span class="gantt-block' . $class . '" style="left: ' . $left . 'px; width: ' . $width . 'px; height: ' . $height . 'px"><strong class="gantt-block-label">'.$block['formateur'].' - '.$block['ville'].'</strong></span>';
      $html[] = '</li>';
